...
try:
    os.remove(r"C:\Users\cnyi\Box Sync\Github\Python-code\TDI_capstone\final_data.csv")
except OSError:
              pass
    
data_full.to_csv(r"C:\Users\cnyi\Box Sync\Github\Python-code\TDI_capstone\final_data.csv",encoding ='utf8', index=False)#,index_label ='index')#, index=False)
